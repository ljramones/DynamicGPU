...
/**
 * Ingestion seam for finalized upstream tessellation payload contracts.
 */
public final class TessellationPayloadIngestion {
  private TessellationPayloadIngestion() {}

  public static GpuTessellationPayload ingest(
      int regionCount,
    ...
    if (regionsIntCount != expectedRegionsIntCount) {
      throw new IllegalArgumentException(
          "upstream tessellation regions int count mismatch: count="
              + regionsIntCount
              + " expected="
  ...
  public static GpuTessellationResource toResource(GpuBuffer buffer, GpuTessellationPayload payload) {
  ...
  public static GpuTessellationResource toResource(
      GpuBufferHandle bufferHandle, GpuTessellationPayload payload) {
    Objects.requireNonNull(bufferHandle, "bufferHandle");
    Objects.requireNonNull(payload, "payload");
    return new GpuTessellationResource(
