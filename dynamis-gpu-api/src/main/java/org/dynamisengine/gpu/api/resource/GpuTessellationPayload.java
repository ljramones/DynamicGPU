...
/**
 * Immutable GPU upload payload contract for tessellation/subdivision regions.
 *
 * <p>Layout v1:
 * <ul>
 *   <li>per-region element width: 6 int32 values</li>
 *   <li>int order: submeshIndex, firstIndex, indexCount, patchControlPoints, tessLevelBits, flags</li>
 *   <li>little-endian packed byte payload</li>
 * </ul>
 */
public final class GpuTessellationPayload {
  ...
  private GpuTessellationPayload(
  ...
  public static GpuTessellationPayload fromLittleEndianBytes(
    ...
    if (intCount != expectedIntCount) {
      throw new IllegalArgumentException(
          "tessellation regions payload int count mismatch: expected="
              + expectedIntCount
              + " actual="
              + intCount);
    }
